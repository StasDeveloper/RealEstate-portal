...
//Yii::app()->clientScript->registerScriptFile(CPathCDN::publish(Yii::app()->theme->basePath . "/js/userPropertyStatusOpt.js", CClientScript::POS_END));
    ...
    $('.datatable_col_reorder').on('click', 'button.exclude_reinclude', clickExcludeIncludeBtn);
     ...
     console.log(13);
        ...
        if (canExclude(1)) {
            ...
            $(this).find('i').toggleClass('fa-reply');
            if($(this).find('i').hasClass('fa-reply')){
...
//Yii::app()->clientScript->registerScriptFile(CPathCDN::publish(Yii::app()->theme->basePath . '/js/details.js', CClientScript::POS_END));
