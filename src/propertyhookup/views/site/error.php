				...
				<div class="row">
					<div class="col-sm-12">
						<div class="text-center error-box">
							...
							<h2 class="font-xl">
								<strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i> <?php echo CHtml::encode($message); ?></strong>
							</h2>

							<?php
							switch($code){
								case '404':
									switch(CHtml::encode($message)) {
										case "This property could be gone already!":
											?>
											<p class="lead">
												The page you requested could not be found.<br/>
												Use your browsers <b>Back</b> button to navigate to the prevous page.
											</p>
											<?php
											break;
										default:
											...
											<p class="lead">
												...
												try again. <br/> Use your browsers <b>Back</b> button to navigate to the
								...
								case '500': ?>
									<p class="lead">
										Oops... Looks like internal server error occurred. <br/> Use your browsers <b>Back</b> button to navigate to the page you have prevously come from
									</p>
							<?php }
							switch(CHtml::encode($message)) {
								case "This property could be gone already!":
