                            ...
                            <table id="user" class="table table-bordered table-striped" style="clear: both">
                                ...
                                <?php foreach($savedSearches as $keySavedSearch=>$savedSearch): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST" action="<?php echo CController::createUrl('property/search')?>">
                                        ...
                                        <td>
                                            <a href="javascript:void(0);"
                                               ...
                                               data-name="name"
                                               data-url="<?php echo CController::createUrl('searches/editable')?>"
                ...
                <?php echo $col2; ?>
                                        ...
                                        <td>
                                            <?php echo CHtml::link('DELETE',
                                                CController::createUrl('searches/Delete'),
                                                array('data-id'=>$savedSearch->id,
...
<!--<script data-pace-options='{ "restartOnRequestAfter": true }' src="--><?php //echo CPathCDN::baseurl( 'js' ); ?><!--/js/plugin/pace/pace.min.js"></script>-->

<!-- Link to Google CDN's jQuery + jQueryUI; fall back to local -->
<!--<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.0.2/jquery.min.js"></script>-->
<script>
    if (!window.jQuery) {
        document.write('<script src="/themes/propertyhookup/js/libs/jquery-2.0.2.min.js"><\/script>');
    }
</script>
...
<!--<script>-->
<!--    if (!window.jQuery.ui) {-->
<!--        document.write('<script src="/themes/propertyhookup/js/libs/jquery-ui-1.10.3.min.js"><\/script>');-->
<!--    }-->
<!--</script>-->
<!---->
...
<!---->
<!--<!-- BOOTSTRAP JS -->-->
<!--<script src="/themes/propertyhookup/js/bootstrap/bootstrap.min.js"></script>-->
<!---->
<!--<!-- CUSTOM NOTIFICATION -->-->
<!--<script src="/themes/propertyhookup/js/notification/SmartNotification.min.js"></script>-->
<!---->
<!--<!-- JARVIS WIDGETS -->-->
<!--<script src="/themes/propertyhookup/js/smartwidgets/jarvis.widget.min.js"></script>-->
<!---->
<!--<!-- EASY PIE CHARTS -->-->
<!--<script src="/themes/propertyhookup/js/plugin/easy-pie-chart/jquery.easy-pie-chart.min.js"></script>-->
<!---->
<!--<!-- SPARKLINES -->-->
<!--<script src="/themes/propertyhookup/js/plugin/sparkline/jquery.sparkline.min.js"></script>-->
<!---->
<!--<!-- JQUERY VALIDATE -->-->
<!--<script src="/themes/propertyhookup/js/plugin/jquery-validate/jquery.validate.min.js"></script>-->
<!---->
<!--<!-- JQUERY MASKED INPUT -->-->
<!--<script src="/themes/propertyhookup/js/plugin/masked-input/jquery.maskedinput.min.js"></script>-->
<!---->
<!--<!-- JQUERY SELECT2 INPUT -->-->
<!--<script src="/themes/propertyhookup/js/plugin/select2/select2.min.js"></script>-->
<!---->
<!--<!-- JQUERY UI + Bootstrap Slider -->-->
<!--<script src="/themes/propertyhookup/js/plugin/bootstrap-slider/bootstrap-slider.min.js"></script>-->
<!---->
<!--<!-- browser msie issue fix -->-->
<!--<script src="/themes/propertyhookup/js/plugin/msie-fix/jquery.mb.browser.min.js"></script>-->
<!---->
<!--<!-- SmartClick: For mobile devices -->-->
<!--<script src="/themes/propertyhookup/js/plugin/smartclick/smartclick.js"></script>-->
...
<!--<script src="/themes/propertyhookup/js/plugin/maxlength/bootstrap-maxlength.min.js"></script>-->
<!--<script src="/themes/propertyhookup/js/plugin/bootstrap-timepicker/bootstrap-timepicker.min.js"></script>-->
<!--<script src="/themes/propertyhookup/js/plugin/bootstrap-tags/bootstrap-tagsinput.min.js"></script>-->
<!--<script src="/themes/propertyhookup/js/plugin/noUiSlider/jquery.nouislider.min.js"></script>-->
<!--<script src="/themes/propertyhookup/js/plugin/ion-slider/ion.rangeSlider.min.js"></script>-->
<!--<script src="/themes/propertyhookup/js/plugin/colorpicker/bootstrap-colorpicker.min.js"></script>-->
<!--<script src="/themes/propertyhookup/js/plugin/knob/jquery.knob.min.js"></script>-->
<!--<script src="/themes/propertyhookup/js/plugin/x-editable/moment.min.js"></script>-->
<!--<script src="/themes/propertyhookup/js/plugin/x-editable/x-editable.js"></script>-->
<!--<script src="/themes/propertyhookup/js/plugin/typeahead/typeahead.min.js"></script>-->
<!--<script src="/themes/propertyhookup/js/plugin/typeahead/typeaheadjs.min.js"></script>-->
