...
(function ($) {
    $.SmartMessageBox = function (settings, callback) {
        ...
        if (isIE8orlower() == 0) {
            ...
            audioElement.setAttribute('src', 'http://js1.irradii.com/assets/sound/messagebox.mp3');
            $.get();
        ...
        if (settings.sound === true) {
            if (isIE8orlower() == 0) {
                ...
                if (navigator.userAgent.match('Firefox/'))
                    audioElement.setAttribute('src', '/themes/propertyhookup/sound/bigbox.ogg');
                else
                    audioElement.setAttribute('src', '/themes/propertyhookup/sound/bigbox.mp3');
    ...
    $.smallBox = function (settings, callback) {
        ...
        if (settings.sound === true) {
            if (isIE8orlower() == 0) {
                ...
                if (navigator.userAgent.match('Firefox/'))
                    audioElement.setAttribute('src', 'http://js1.irradii.com/assets/sound/smallbox.ogg');
                else
                    audioElement.setAttribute('src', 'http://js1.irradii.com/assets/sound/smallbox.mp3');
