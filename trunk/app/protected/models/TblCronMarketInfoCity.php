 ...
 *
 * The followings are the available columns in table '{{cron_market_info_city}}':
 * @property integer $id
 ...
 */
class TblCronMarketInfoCity extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('city_id, date, total, sale, sold, foreclosure, short_sales, avg_price, high_ppsf, low_ppsf, avg_ppsf', 'required'),
			array('city_id, total, sale, sold, foreclosure, short_sales', 'numerical', 'integerOnly'=>true),
			array('avg_price, high_ppsf, low_ppsf, avg_ppsf', 'numerical'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, city_id, date, total, sale, sold, foreclosure, short_sales, avg_price, high_ppsf, low_ppsf, avg_ppsf', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TblCronMarketInfoCity the static model class
	 */
