...
/**
 * This is the model class for table "transcation_ebooks".
 *
 * The followings are the available columns in table 'transcation_ebooks':
 ...
 */
class TranscationEbooks extends CActiveRecord
{
	/**
	 ...
	 * @return TranscationEbooks the static model class
	 */
