 ...
 *
 * The followings are the available columns in table '{{cron_market_info_county}}':
 * @property integer $id
 ...
 */
class TblCronMarketInfoCounty extends CActiveRecord
{
	/**
	...
	{
		return '{{cron_market_info_county}}';
	}
	...
	public function rules()
	{
		...
		return array(
			array('county_id, date, total, sale, sold, foreclosure, short_sales, avg_price, high_ppsf, low_ppsf, avg_ppsf', 'required'),
			array('county_id, total, sale, sold, foreclosure, short_sales', 'numerical', 'integerOnly'=>true),
			array('avg_price, high_ppsf, low_ppsf, avg_ppsf', 'numerical'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, county_id, date, total, sale, sold, foreclosure, short_sales, avg_price, high_ppsf, low_ppsf, avg_ppsf', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TblCronMarketInfoCounty the static model class
	 */
