...
/**
 * This is the model class for table "ebooks_shoping_card_temp".
 *
 * The followings are the available columns in table 'ebooks_shoping_card_temp':
 ...
 */
class EbooksShopingCardTemp extends CActiveRecord
{
	/**
	...
	{
		return 'ebooks_shoping_card_temp';
	}
	 ...
	 * @return EbooksShopingCardTemp the static model class
	 */
