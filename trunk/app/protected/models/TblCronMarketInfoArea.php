 ...
 *
 * The followings are the available columns in table '{{cron_market_info_area}}':
 * @property integer $id
 ...
 */
class TblCronMarketInfoArea extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('area, date, total, sale, sold, foreclosure, short_sales, avg_price, high_ppsf, low_ppsf, avg_ppsf', 'required'),
			...
			array('id, area, date, total, sale, sold, foreclosure, short_sales, avg_price, high_ppsf, low_ppsf, avg_ppsf', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TblCronMarketInfoArea the static model class
	 */
