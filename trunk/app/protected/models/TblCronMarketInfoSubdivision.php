 ...
 *
 * The followings are the available columns in table '{{cron_market_info_subdivision}}':
 * @property integer $id
 ...
 *
 */
class TblCronMarketInfoSubdivision extends CActiveRecord
{
	/**
	...
	{
		return '{{cron_market_info_subdivision}}';
	}
	...
	public function rules()
	{
		...
		return array(
			array('subdivision, date, total, sale, sold, foreclosure, short_sales, avg_price, high_ppsf, low_ppsf, avg_ppsf', 'required'),
			array('total, sale, sold, foreclosure, short_sales', 'numerical', 'integerOnly'=>true),
			array('avg_price, high_ppsf, low_ppsf, avg_ppsf', 'numerical'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, subdivision, date, total, sale, sold, foreclosure, short_sales, avg_price, high_ppsf, low_ppsf, avg_ppsf', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TblCronMarketInfoSubdivision the static model class
	 */
