 ...
 *
 * The followings are the available columns in table 'property_info_details':
 ...
 */
class PropertyInfoDetails extends CActiveRecord
{
	/**
	 ...
	 * @return PropertyInfoDetails the static model class
	 */
