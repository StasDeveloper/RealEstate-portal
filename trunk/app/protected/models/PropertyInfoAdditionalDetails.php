 ...
 *
 * The followings are the available columns in table 'property_info_additional_details':
 ...
 */
class PropertyInfoAdditionalDetails extends CActiveRecord
{
	/**
	 ...
	 * @return PropertyInfoAdditionalDetails the static model class
	 */
