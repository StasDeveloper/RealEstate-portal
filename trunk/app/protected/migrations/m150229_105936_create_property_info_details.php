...
class m150229_105936_create_property_info_details extends CDbMigration
{
    public function up()
    {
        $this->createTable('{{property_info_details}}', array(
    ...
    {
        $this->dropTable('{{property_info_details}}');
    }
}