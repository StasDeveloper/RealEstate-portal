...
class m150428_110552_create_property_info_additional_details_history extends CDbMigration

{
...

    {
        ...
        $this->createTable('{{property_info_additional_details_history}}', [
    ...
    {
        $this->dropTable('property_info_additional_details_history');
    }
}
