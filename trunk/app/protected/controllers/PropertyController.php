...
class PropertyController extends Controller {
    ...
    public $status_types = array(
        ...
        'Pending' => array(
            'PENDING OFFER', 'CONTINGENT OFFER'
        ),
        'Sold' => array(
...
//            echo json_encode($this->getExcludedStatusesStr($property_id));
    ...
    private function actionComparePropertyInfo($property_id, $session_id, $gettoday_date, $comp_time, $compare_property_type, $compare_property_zipcode, $compare_property_year_build, $compare_lot_sq_footage, $compare_house_sq_footage, $compare_property_lon, $compare_property_lat, $property_id,
...
//Yii::log('actionComparePropertyInfo sql: ' . $sql ,'ERROR');
    ...
    private function actionComparePropertyInfoAllRows($property_id, $session_id, $gettoday_date, $comp_time, $compare_property_type, $compare_property_zipcode, $compare_property_year_build, $compare_lot_sq_footage, $compare_house_sq_footage, $compare_property_lon, $compare_property_lat, $property_id,
                    $compare_bedrooms, $compare_bathrooms, $compare_subdivision, $compare_house_views, $compare_sub_type) {
...
//        $select_query_delete_1 = $this->actionGetExcludeProperty($session_id);
        ...
        if (($compare_lot_sq_footage != '') ||
            ...
            $result_queryAllRows = $this->actionComparePropertyInfoAllRows(
                    $property_id, $session_id, $gettoday_date, $comp_time, $compare_property_type, $compare_property_zipcode, $compare_property_year_build, $compare_lot_sq_footage, $compare_house_sq_footage, $compare_property_lon, $compare_property_lat, $property_id,
                    $compare_bedrooms, $compare_bathrooms, $compare_subdivision, $compare_house_views, $compare_sub_type);
...
//$time_start = $time_start1;
        ...
        if(trim($street_number)){
            $sub_query .= !empty($searchForm['street_address']) ? ' @property_street "' . $street_number. ' ' . $searchForm['street_address'] . '"' : '';

        } else {
            $sub_query .= !empty($searchForm['street_address']) ? ' @property_street "' . $searchForm['street_address'] . '"' : '';
