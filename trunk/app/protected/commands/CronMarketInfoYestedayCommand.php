...
class CronMarketInfoYestedayCommand extends CConsoleCommand {
    ...
    public function run() {
        ...
        $content .= $this->actionCountSameSubdivisionYesterday($yesterday, $interval);
        $content .= $this->actionCountSameAreaYesterday($yesterday, $interval);
        $content .= $this->actionCountSameZipCodeYesterday($yesterday, $interval);
        $content .= $this->actionCountSameCityYesterday($yesterday, $interval);
        $content .= $this->actionCountSameCountyYesterday($yesterday, $interval);
        $content .= $this->actionCountSameStateYesterday($yesterday, $interval);
    ...
    private function actionCountSameSubdivisionYesterday($yesterday, $interval){
        $start = time();
        if ( Yii::app()->db->createCommand("INSERT INTO `tbl_cron_market_info_subdivision`(
                                                    ...
                                                    `low_ppsf`, 
                                                    `avg_ppsf`) 
                                                    SELECT null, `tbl_p`.`subdivision`, ADDDATE('".$yesterday."', ".$interval."),
    ...
    private function actionCountSameAreaYesterday($yesterday, $interval){
        $start = time();
        if ( Yii::app()->db->createCommand("INSERT INTO `tbl_cron_market_info_area`(
                                                    ...
                                                    `low_ppsf`, 
                                                    `avg_ppsf`) 
                                                    SELECT null, `tbl_p`.`area`, ADDDATE('".$yesterday."', ".$interval."),
    ...
    private function actionCountSameZipCodeYesterday($yesterday, $interval){
        $start = time();
        if(Yii::app()->db->createCommand(
                "INSERT INTO `tbl_cron_market_info_zipcode`(
                    ...
                    SELECT null, `tbl_p`.`property_zipcode`, ADDDATE('".$yesterday."', ".$interval.") , 
    ...
    private function actionCountSameCityYesterday($yesterday, $interval){
        $start = time();
        if(Yii::app()->db->createCommand(
                "INSERT INTO `tbl_cron_market_info_city`(
                    ...
                    SELECT null, `tbl_p`.`property_city_id`, ADDDATE('".$yesterday."', ".$interval.") , 
    ...
    private function actionCountSameCountyYesterday($yesterday, $interval){
         $start = time();
        if(Yii::app()->db->createCommand(
                "INSERT INTO `tbl_cron_market_info_county`(
                    ...
                    SELECT null, `tbl_p`.`property_county_id`, ADDDATE('".$yesterday."', ".$interval.") , 
    ...
    private function actionCountSameStateYesterday($yesterday, $interval){
         $start = time();
        if(Yii::app()->db->createCommand(
                "INSERT INTO `tbl_cron_market_info_state`(
                    ...
                    SELECT null, `tbl_p`.`property_state_id`, ADDDATE('".$yesterday."',".$interval.") , 
