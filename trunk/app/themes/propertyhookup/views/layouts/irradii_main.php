...
<!--        --><?php //$cs->registerCssFile(CPathCDN::gzipPublish('//fonts.googleapis.com/css?family=Open+Sans:400italic,700italic,300,400,700|Open+Sans+Condensed:300|Muli', 'text/css')); ?>
        <?php $cs->registerCssFile($themePath.'/css/concat-style.min.css'); ?>
<!--        --><?php //$cs->registerCssFile(CPathCDN::gzipPublish(Yii::app()->theme->basePath . '/css/concat-style.min.css', 'text/css'));?>
    </head>
    <!--here-->
                ...
                <div class="header-right-container">
                    ...
                    <?php if (!Yii::app()->user->isGuest): ?>
                        <div id="logout" class="btn-header transparent pull-right">
                            <span>
                                <a href="<?php echo  Yii::app()->createUrl('/user/logout'); ?>" title="Sign Out"><i class="fa fa-sign-out"></i></a>
                            </span>
                        </div>
                    <?php endif; ?>
                    <?php if(SiteHelper::forFullPaidMembersOnly(true) !== true && !$trial){ ?>
...
<!--        --><?php //$cs->registerCoreScript('jquery');
        ...
        <?php $cs->registerScriptFile($themePath.'/js/concat-build.min.js', CClientScript::POS_END); //included .js files are listed in Gruntfile.js ?>
